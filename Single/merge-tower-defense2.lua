...
CurrencyTab:CreateToggle("money aura", function(value)
collectmoney = value
end)
...
WeaponsTab:CreateToggle("instant kill", function(value)
instantkill = value
end)

WeaponsTab:CreateSlider("Multiplier",1,10,1,false,function(value)
multiplier = value
end)
